...
El primer paso es declarar cuál es el servidor de Dataverse que emplearemos para descargar nuestro set de datos. La función `Sys.setenv` permite asignar un objeto llamdo `DATAVERSE_SERVER` al cual le asignamos el Dataverse de Harvard, donde se ha sido guardado **ELSOC.**
...
#### Alternativa A
```{r descargar1, eval=FALSE, include=TRUE, results='hold'}
#--- Alternativa A -----
...
```{r ELSOC2017, eval=FALSE, include=TRUE, results='hold'}
# ElSOC 2017 --------------------------------------------------------------
